...
- (void)configureSendButtonWithStyle:(JSMessageInputViewStyle)style
{
    ...
    if (style == JSMessageInputViewStyleClassic) {
        ...
        [sendButton setTitleColor:[UIColor dnColor] forState:UIControlStateNormal];
        [sendButton setTitleColor:[UIColor dnColor] forState:UIControlStateHighlighted];
    ...
    NSString *title = NSLocalizedString(@"Post", nil);
